...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [ISSUE-001](issues/ISSUE-001.md) | JSON lifecycle: rendered output survives persistent server reset | Ready | Pull request | New pull request | High | Review exact JSON reset PR | Not published. |
